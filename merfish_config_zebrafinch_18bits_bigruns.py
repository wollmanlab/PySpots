...
parameters = {}
""" General """
parameters['daemon_path'] = '/scratch/test_daemon_FX_18bits_bigruns' #bigstore/GeneralStorage/daemon' #'/scratch/daemon/' # Where should the Daemons Look
parameters['utilities_path'] = '/scratch/test_utility_FX_18bits_bigruns'#'/scratch/utilities/' # Where to save temporary files
parameters['fishdata'] = 'fishdata_testFX_18bits_bigruns' #Directory Name for Processed Data >Bigstore>Images[Year]>User.Project>Dataset>fishdata
