...
parameters = {}
""" General """
parameters['daemon_path']= '/scratch/test_daemon_FX' #bigstore/GeneralStorage/daemon' #'/scratch/daemon/' # Where should the Daemons Look
parameters['utilities_path']= '/scratch/test_merfish_FX'#'/scratch/utilities/' # Where to save temporary files
parameters['fishdata']='fishdata_testFX' #Directory Name for Processed Data >Bigstore>Images[Year]>User.Project>Dataset>fishdata
