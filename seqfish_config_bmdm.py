...
# config_options
codebook_pth = '/bigstore/binfo/Codebooks/BMDM_NFkB_120919.csv'
...
f = open('/bigstore/GeneralStorage/Zach/MERFISH/Probe_Design/results/OligoPool_19Dec2019/bmdm_nfkb_v2_possible_oligos.fasta', 'r')
s = f.read()
f.close()
