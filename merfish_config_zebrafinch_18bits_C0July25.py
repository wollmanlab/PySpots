...
parameters = {}
""" General """
parameters['daemon_path'] = '/scratch/test_daemon_FX_18bits_C0July25' #bigstore/GeneralStorage/daemon' #'/scratch/daemon/' # Where should the Daemons Look
parameters['utilities_path'] = '/scratch/test_utility_FX_18bits_C0July25'#'/scratch/utilities/' # Where to save temporary files
