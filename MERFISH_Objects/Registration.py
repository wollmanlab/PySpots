...
class Registration_Class(object):
    ...
    def calculate_transformation(self):
        ...
        """
        self.ref_beadarray = self.utilities.load_data(Dataset=self.dataset,Position=self.posname,Hybe=self.hybe,Type='ref_beadarray')
        self.ref_tree = self.utilities.load_data(Dataset=self.dataset,Position=self.posname,Hybe=self.hybe,Type='ref_tree')
        self.db_clusts = self.utilities.load_data(Dataset=self.dataset,Position=self.posname,Hybe=self.hybe,Type='db_clusts')
